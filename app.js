...
var budgetController = (function() {
	...
	Expanse.prototype.calculatePercentages = function(totalIncome) {
...
var controller = (function(budgetCtrl, UICtrl) {
	...
	var updatePercentages = function() {
		...
		// update the UI with the new percantages
	...
	var ctrlAddItem = function () {
		...
		newHtml = UICtrl.addListItem(newItem, input.type);
	...
	var ctrlDeleteItem = function(event) {
		...
		// ДОБАВИТЬ еще 1 parentNode когда будет доступ к иконкам
